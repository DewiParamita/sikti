...
<html lang="en">
<head>
<title>SIKTI - Edit Discussion</title>
<meta charset="utf-8">
...
<!-- content -->
			<article id="content">
				<div class="wrap">
					...
					<div class="box">
						<div>
							<center><h2 class="letter_spacing">Edit Discussion <span>Form</span></h2></center>
							<?php
							 $attributes = array('id' => 'ContactForm');
							 echo form_open('discussion_ctrl/edit_discussion', $attributes); ?> 
							<?php if(isset($message))
								...
								<div>
									...
									<div class="wrapper">
										...
										value="<?php if(isset($topic)) echo $topic;?>">
									</div>
									<br>
									<div class="wrapper">
									...
									<center>
										...
										<a><input type="submit" class="button2" value="Post"></a>
