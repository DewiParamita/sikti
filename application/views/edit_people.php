...
<!-- content -->
			<article id="content">
				<div class="wrap">
					...
					<div class="box">
						<div>
							<center><h2 class="letter_spacing">Edit People <span>Form</span></h2></center>
							<?php
							 $attributes = array('id' => 'ContactForm');
							 echo form_open('people_ctrl/edit_people', $attributes); ?> 
							<?php if(isset($message))
								echo $message; ?>	
								<div>
									<div style="display:none">
									<input type="text" class="input" id="id_people" name="id_people" 
										value="<?php if(isset($id_people)) echo $id_people;?>">
									</div>
									<br>
									<br>
									<div class="wrapper">
										<span>Name:</span>
										<input type="text" class="input" id="people_name" name="people_name" 
										value="<?php if(isset($people_name)) echo $people_name;?>">
									</div>
									<br>
									<div class="wrapper">
										<span>Email:</span>
									...
									<div class="wrapper">
										<span>Type: (i)</span>
										<input type="radio" name="tipe" id="tipe" value="1" 
										
										<?php if(isset($tipe))
										{
											if($tipe=='1')
											{
												echo set_radio('tipe','1', TRUE);
												
											}
										}?>> Account</input>
										<input type="radio" name="tipe" id="tipe" value="2" 
										<?php if(isset($tipe))
										{
											if($tipe=='2')
											{
												echo set_radio('tipe','2', TRUE);
									...
									<div class="wrapper">
										<span>Position:</span>
											<select class="input" id="select_position" name="select_position">
											<?php 
											if(isset($position))
											{
												...
												{ 
												?>
													<option value="<?php echo $rows->id_position;?>" 
													<?php 
														if($rows->id_position==$id_position)
														 echo set_select('select_position', $rows->id_position, TRUE ); ?>
													>
									...
									if(isset($tipe))
										{
											...
											<div id="select">
												<div class="wrapper">
												<span>Username:</span>
													<input type="text" class="input" id="username2" name="username2"
													value="<?php if(isset($username2)) echo set_value('username2', $username2);?>">
												</div>
												<br>
												<div class="wrapper">
													<span>Password:</span>
