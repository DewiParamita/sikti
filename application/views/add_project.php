...
<!-- content -->
			<article id="content">
				<div class="wrap">
					...
					<div class="box">
						<div>
							<center><h2 class="letter_spacing">Add Project <span>Form</span></h2></center>
							<?php
							 $attributes = array('id' => 'ContactForm');
							 echo form_open('project_ctrl/add_project', $attributes); ?> 
							<?php if(isset($message))
								...
								<div>
									...
									<div class="wrapper">
										...
										<input type="text" class="input" id="project_name" name="project_name" 
									...
									<br>
									<div class="wrapper">
										What's this project for?<br>
										<input type="radio" name="project_for" id="project_for" value="Yes" 
										
										<?php if(isset($project_for))
										{
											if($project_for=='Yes')
											{
												echo set_radio('project_for','Yes', TRUE);
												
											}
										}?>> Client</input>
										<input type="radio" name="project_for" id="project_for" value="No" 
										<?php if(isset($project_for))
										{
											if($project_for=='No')
											{
												echo set_radio('project_for','No', TRUE);
									...
									if(isset($project_for))
										{
											...
											<div id="select">
												<div class="wrapper">
												<br>
												Select an existing client/company:
												<select class="input" id="select_client"  name="select_client">
													<?php 
													if(isset($client))
													{
														...
														?>
															...
															echo set_select('select_client', '4', TRUE); ?>>
												...
												<a href="<?php echo site_url('project_ctrl/display_add_company');?>">
												<img src="<?php echo base_url();?>images/icon/add.png" width="20px" alt="">Add New Company</a>
											</div>
											<br>
											</div>
											<?php 
											...
											<div style="display:none;" id="select">
												...
												<select class="input" id="select_client" name="select_client">
													...
													if(isset($client))
													{
														...
														{ 
														?>
														  <option value="<?php echo $rows->id_user;?>"><?php echo $rows->nama;?></option>
													<?php
														}
													}	?>
												...
												<div class="wrapper">
												Or add a new company:
												<a href="<?php echo site_url('project_ctrl/display_add_company');?>"><img src="<?php echo base_url();?>images/icon/add.png" width="20px" alt="">Add New Company</a>
											</div>
											<br>
											</div>
											<?php
