				...
				<section class="col-full"><div class="wrap-col">
					...
					if(isset($jml_discussion))
					{
						...
						{?>
							<article id="content">
								<div class="wrap">
									<div>
										<center><h2>No Discussion<span>!</span></h2>
										<figure><img src="<?php echo base_url();?>images/icon/discussions.png" alt="" ></figure></center>
										<p class="pad_bot1">You can start new discussion with your team members. You can share your ideas and info to the others team members.</p>
										<center><a href="<?php echo site_url('discussion_ctrl/display_add_discussion');?>" class="button1">Create the first discussion</a></center>									
									</div>									
								</div>
							</article>	
						<?php
					...
					if(isset($jml_discussion))
					{
							...
							
						{
							if($tipe=='tim')
							{?>
								<a href="<?php echo site_url('discussion_ctrl/display_add_discussion');?>">
								<img src="<?php echo base_url();?>images/icon/add.png" width="20px" alt="">Add Discussion</a>
							<?php
							}?>
					    <div class="tab1" >
							<table >
								...
								<tr>
									...
									<td><strong><a href="<?php echo site_url('comment_ctrl/display_comment');?>?id=<?php echo $rows->id_discussion;?>" ><?php echo $rows->topic;?></a></strong><br>
									<?php echo $rows->deskripsi;?>
									<td><?php $posted=$this->discussion_model->get_posted_by($rows->id_discussion); 
									...
									if($tipe=='tim')
									{?>
										<td><a href="<?php echo site_url('discussion_ctrl/display_edit_discussion');?>?id=<?php echo $rows->id_discussion;?>">
										<img src="<?php echo base_url();?>images/icon/edit.png" width="20px" alt=""> Edit</a>
										<br>
										<img src="<?php echo base_url();?>images/icon/delete.png" width="20px" alt="">
										<a onClick="var r=confirm('Are you sure want to delete this discussion?'); 
										if (r==true){
											return true;
										}else{
											return false;
										}" 
										href="<?php echo site_url('discussion_ctrl/delete_discussion');?>?id=<?php echo $rows->id_discussion;?>">Delete</a></td>
										</tr>
									<?php
									}
									}
