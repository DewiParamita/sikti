...
<!-- content -->
			<article id="content">
				<div class="wrap">
					...
					<div class="box">
						<div>
							<center><h2 class="letter_spacing">Add People <span>Form</span></h2></center>
							<?php
							 $attributes = array('id' => 'ContactForm');
							 echo form_open('people_ctrl/add_people', $attributes); ?> 
									...
									<div class="wrapper">
										<span>Position:</span>
											...
											if(isset($position))
											{
												...
												{ 
												?>
													<option value="<?php echo $rows->id_position;?>"><?php echo $rows->position;?></option>
												<?php
												}
											}	?>
											</select>
