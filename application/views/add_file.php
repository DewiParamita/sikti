...
<!-- content -->
			<article id="content">
				<div class="wrap">
					...
					<div class="box">
						<div>
							<center><h2 class="letter_spacing">Add File <span>Form</span></h2></center>
							<?php
							 $attributes = array('id' => 'ContactForm');
							 echo form_open_multipart('file_ctrl/add_file', $attributes); ?> 
							<?php if(isset($message))
								...
								<div>
									...
									<div class="wrapper">
										...
										value="<?php if(isset($judul)) echo $judul;?>">
									</div>
									<br>
									<div class="wrapper">
