...
<html lang="en">
<head>
<title>SIKTI - Add Project Offers</title>
<meta charset="utf-8">
					...
					<div class="box">
						<div>
							...
							<?php
							 ...
							 echo form_open('offers_ctrl/add_offers', $attributes); ?> 
							<?php if(isset($message))
								...
								<div>							
									...
									<br>
									<div class="wrapper">
										<span>Budget: <br>(in IDR) </span>
										<input type="text" class="input" name="budget" id="budget"
