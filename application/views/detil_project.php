...
<html lang="en">
<head>
<title>SIKTI - Project Detail</title>
<meta charset="utf-8">
			...
			<div class="wrapper">
				<section class="col-full"><div class="wrap-col">
					<h2><?php echo $nama;?></h2>
						...
						<?php if($deskripsi!='') echo $deskripsi; else echo '-';?>							
						<br>
						...
						<?php 
							$end=date('d-m-Y', strtotime($start_date.'+'.$duration.'days'));
							echo $end;?>
						<br>
						<span><strong>Project For : </strong></span>
