...
<!-- content -->
			<article id="content">
				<div class="wrap">
					...
					<div class="box">
						<div>
							<center><h2 class="letter_spacing">Edit Task <span>Form</span></h2></center>
							<?php
							 $attributes = array('id' => 'ContactForm');
							 echo form_open('task_ctrl/edit_task', $attributes); ?> 
							<?php if(isset($message))
								echo $message; ?>	
														
								<div>
									<div style="display:none">
									<input type="text" class="input" id="id_task" name="id_task" 
										value="<?php if(isset($id_task)) echo $id_task;?>">
									</div>
									<br>
									<div class="wrapper">
										<span>Task Name:</span>
									...
									<div class="wrapper">
									<span>Progress:</span>
									<select name="select_progress" class="input">
										<option value="0" <?php if($progress=='0') echo set_select('select_progress','0', TRUE);?>>0%</option>
										<option value="10" <?php if($progress=='10') echo set_select('select_progress','10', TRUE);?>>10%</option>
										<option value="20" <?php if($progress=='20') echo set_select('select_progress','20', TRUE);?>>20%</option>
										<option value="30" <?php if($progress=='30') echo set_select('select_progress','30', TRUE);?>>30%</option> 
										<option value="40" <?php if($progress=='40') echo set_select('select_progress','40', TRUE);?>>40%</option>
										<option value="50" <?php if($progress=='50') echo set_select('select_progress','50', TRUE);?>>50%</option>
										<option value="60" <?php if($progress=='60') echo set_select('select_progress','60', TRUE);?>>60%</option>
										<option value="70" <?php if($progress=='70') echo set_select('select_progress','70', TRUE);?>>70%</option>
										<option value="80" <?php if($progress=='80') echo set_select('select_progress','80', TRUE);?>>80%</option>
										<option value="90" <?php if($progress=='90') echo set_select('select_progress','90', TRUE);?>>90%</option>
										<option value="100" <?php if($progress=='100') echo set_select('select_progress','100', TRUE);?>>100%</option>
									</select>
									</div>
									<br>
									<div class="wrapper">
