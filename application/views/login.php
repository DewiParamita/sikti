...
<!----Untuk checkbox show pass---------->
<script type="text/javascript" src="<?php echo base_url();?>js/ShowPasswordCheckbox.js"></script>
...
<!-- content -->
			<article id="content">
				<div class="wrap">
					...
					<div class="box">
						<div>
							<center><h2 class="letter_spacing">Login <span>Form</span></h2></center>
							
							<?php
							 $attributes = array('id' => 'ContactForm');
							 echo form_open('user_ctrl/login', $attributes); ?> 
							<!--<form id="ContactForm" action="<?php echo site_url('user_ctrl/login');?>" >-->
								<div>
									<br>
									<div class="wrapper">
										<span>Username:</span>
									...
									<pre>             <a href="<?php echo site_url('display/display_reset_password');?>">Forgot Password?</a></pre>	
