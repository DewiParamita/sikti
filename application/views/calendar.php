...
<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>css/style_2.css"/>
<!--[if lt IE 9]>
						...
						<div id="sticky_navigation">
							...
							<div><a class="project_title" href="<?php echo site_url('project_ctrl/detil_project');?>?id=<?php echo $id_project;?>"><?php echo $nama;?></a></div>
								<ul>
									...
									<li><a href="<?php echo site_url('calendar_ctrl/notes');?>"  class="selected"><img src="<?php echo base_url();?>images/icon/calendar.png" width="30px" alt="Calendar">Calendar</a></li>
								</ul>
							</div>
						</div>
					</div>
