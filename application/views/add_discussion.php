...
<html lang="en">
<head>
<title>SIKTI - Add Discussion</title>
<meta charset="utf-8">
...
<!-- content -->
			<article id="content">
				<div class="wrap">
					...
					<div class="box">
						<div>
							<center><h2 class="letter_spacing">Add Discussion <span>Form</span></h2></center>
							<?php
							 $attributes = array('id' => 'ContactForm');
							 echo form_open('discussion_ctrl/add_discussion', $attributes); ?> 
