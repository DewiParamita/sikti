<div style="width:500px; height:130px; overflow:auto; color:#000000; margin-bottom:20px;" border="1px" align="center">
	
	<h4>Tambah catatan untuk tanggal <?php echo "$day $month $year"?></h4>
	
	<?php echo form_open("calendar_ctrl/do_add/$year/$mon/$day");?>
	<table>
