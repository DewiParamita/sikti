...
<html lang="en">
<head>
<title>SIKTI - Edit Project</title>
<meta charset="utf-8">
				...
				<div class="wrap">
					...
					<div class="box">
						<div>
							...
							<center><h2 class="letter_spacing">Edit Project <span>Form</span></h2></center>
							<?php
							 $attributes = array('id' => 'ContactForm');
							 echo form_open('project_ctrl/edit_project', $attributes); ?> 
							<?php if(isset($message))
								...
								<div>
									...
									<input type="text" class="input" id="id_project" name="id_project" 
										value="<?php if(isset($id_project)) echo $id_project;?>">
									</div>
									<div class="wrapper">
