				...
				<article id="content">
					<div class="wrap">
						<section class="col-1-2"><div class="wrap-col1">
							<div class="box">
								<div>
									<center><h2>No <span>Task!</span></h2>
									<figure><img src="<?php echo base_url();?>images/icon/task.png" alt="" ></figure></center>
									<p class="pad_bot1">You don't have any task yet. Let's create new task by click the button below. Task can be the list of fungsionality or the things that must do.</p>
									<center><a href="<?php echo site_url('task_ctrl/display_add_task');?>" class="button1">Create new task</a></center>
		...
		<article id="content2">
			<div class="wrapper">
				...
				<div class="wrap-col">
					...
					<div class="wrapper">
						<a href="<?php echo site_url('task_ctrl/display_add_task');?>"><img src="<?php echo base_url();?>images/icon/add.png" width="20px" alt="">Add Task</a>
						<div class="tab" >
							<table >
								<tr>
									<td>No</td>
								...
								<tr>
									...
									<td><strong><?php echo $rows->nama;?></strong><br>
									<?php echo $rows->deskripsi;?></td>
									<td><center><?php 
									...
									<td><?php $responsible=$this->people_model->get_people_by_id($rows->responsible);
										foreach($responsible as $row)
											$res=$row->nama;
											echo $res;
										?></td>
									<td><center><?php echo $rows->progress . ' %';?></center></td>
									<td><center><a href="<?php echo site_url('task_ctrl/display_edit_task');?>?id=<?php echo $rows->id_task;?>"><img src="<?php echo base_url();?>images/icon/edit.png" width="20px" alt="">Edit</a></center></td>
								...
								href="<?php echo site_url('task_ctrl/delete_task');?>?id=<?php echo $rows->id_task;?>">Delete</a></center></td>
								</tr>
								<?php
									}
								}?>
