				...
				<header>
					...
					<nav>
						<ul id="menu">
							...
							<li class="active"><a href="<?php echo site_url('display/display_client_list');?>">Clients</a></li>
			...
			<div class="wrapper">
				<section class="col-full"><div class="wrap-col">
					...
					<?php 
						...
						echo form_open_multipart('user_ctrl/search_client', $attributes); ?>
						...
						<label class="control-label" for="name">Search : &nbsp;&nbsp;</label>
							<?php if(!isset($keyword)) $keyword = '';
								$data = array(
									...
									'maxlength' => '100',
									'size' => '40',
									'style' => 'height:10000%; width:200px;',
									'placeholder' => 'Keyword');
								echo form_input($data); ?>
									
							&nbsp;<input type="image" id="search" src="<?php echo base_url();?>images/icon/search.png" height="20px">
							<errorText> <?php echo form_error('search'); ?> </errorText>
						</form>
						
					<h2>IT Consultant</h2>
					<p>Here are all IT Consultant that've join with us.</p>
					<!--<?php 
						if($count_consultant>6)
						{?>
						Page :
						...
						foreach($consultant as $rows)
						{
							...
							<div class="col-1-6"><div class="wrap-col">
								<div class="wrapper pad_bot1">
									<figure class="pad_bot1"><img src="<?php echo base_url(); echo substr($rows->foto,22) ?>" alt="" width="250px"></figure>
									<a><strong><?php echo $rows->nama;?></strong></a><br>
									<strong><?php echo $rows->kategori;?></strong><br>
					...
					<?php
							...
							{?>
							<div class="col-1-6"><div class="wrap-col mag-1">
								<div class="wrapper pad_bot1">
									<figure class="pad_bot1"><img src="<?php echo base_url(); echo substr($rows->foto,22) ?>" alt="" width="250px"></figure>
									<a><strong><?php echo $rows->nama;?></strong></a><br>
									<strong><?php echo $rows->kategori;?></strong><br>
				...
				<section class="col-full"><div class="wrap-col">
					<h2>Company</h2>
					<p>Here are all companies that've join with us.</p>
					<!--<?php 
						if($count_company>6)
						{?>
						Page :
