...
<html lang="en">
<head>
<title>SIKTI - Add Position</title>
<meta charset="utf-8">
...
<!-- content -->
			<article id="content">
				<div class="wrap">
					...
					<div class="box">
						<div>
							<center><h2 class="letter_spacing">Add Position <span>Form</span></h2></center>
							<?php
							 $attributes = array('id' => 'ContactForm');
							 echo form_open('position_ctrl/add_position', $attributes); ?> 
